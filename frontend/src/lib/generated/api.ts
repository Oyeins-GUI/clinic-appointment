...
import { BodyType, customFetch, ErrorType } from "../custom-fetch";
...
export const getListAppointmentSlotsUrl = (
   params?: ListAppointmentSlotsParams,
) => {
   ...
   return stringifiedParams.length > 0
      ? `/api/appointment-slots?${stringifiedParams}`
...
export const getListAppointmentSlotsQueryKey = (
   params?: ListAppointmentSlotsParams,
) => {
   return [`/api/appointment-slots`, ...(params ? [params] : [])] as const;
};

export const getListAppointmentSlotsQueryOptions = <
   TData = Awaited<ReturnType<typeof listAppointmentSlots>>,
   TError = ErrorType<unknown>,
>(
   params?: ListAppointmentSlotsParams,
   options?: {
      query?: UseQueryOptions<
         Awaited<ReturnType<typeof listAppointmentSlots>>,
         TError,
         TData
      >;
      request?: SecondParameter<typeof customFetch>;
   ...
   const queryKey =
      queryOptions?.queryKey ?? getListAppointmentSlotsQueryKey(params);

   const queryFn: QueryFunction<
      Awaited<ReturnType<typeof listAppointmentSlots>>
   > = ({ signal }) =>
      listAppointmentSlots(params, { signal, ...requestOptions });
...
export type ListAppointmentSlotsQueryResult = NonNullable<
   Awaited<ReturnType<typeof listAppointmentSlots>>
>;
...
export const getListPatientAppointmentsUrl = (
...
export const getListPatientAppointmentsQueryKey = (
   params?: ListPatientAppointmentsParams,
) => {
...
>(
   ...
   const queryKey =
      queryOptions?.queryKey ?? getListPatientAppointmentsQueryKey(params);

   const queryFn: QueryFunction<
      Awaited<ReturnType<typeof listPatientAppointments>>
   > = ({ signal }) =>
      listPatientAppointments(params, { signal, ...requestOptions });
...
export const getGetClinicSummaryQueryKey = () => {
   return [`/api/clinic-summary`] as const;
};

export const getGetClinicSummaryQueryOptions = <
   TData = Awaited<ReturnType<typeof getClinicSummary>>,
   TError = ErrorType<unknown>,
>(options?: {
   query?: UseQueryOptions<
      Awaited<ReturnType<typeof getClinicSummary>>,
      TError,
      TData
   >;
   request?: SecondParameter<typeof customFetch>;
   ...
   const queryFn: QueryFunction<
      Awaited<ReturnType<typeof getClinicSummary>>
   > = ({ signal }) => getClinicSummary({ signal, ...requestOptions });
...
export type GetClinicSummaryQueryResult = NonNullable<
   Awaited<ReturnType<typeof getClinicSummary>>
>;
...
export function useGetClinicSummary<
   TData = Awaited<ReturnType<typeof getClinicSummary>>,
   TError = ErrorType<unknown>,
>(options?: {
   query?: UseQueryOptions<
