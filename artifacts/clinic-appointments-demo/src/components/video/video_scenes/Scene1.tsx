...
export function Scene1() {
   return (
      <SceneShell tint="cream" accent>
         ...
         <div className="absolute left-[6vmin] top-[4vmin] z-10">
            <Wordmark />
         </div>
         <div className="relative z-10 flex h-full items-center px-[6vmin]">
            <div className="w-[49%] pt-[2vmin]">
               ...
               >
                  The queue can wait.
                  <br />
                  <span className="text-[#d95d45]">
                     Your care shouldn&apos;t.
                  </span>
               </motion.h1>
               <motion.p
                  className="mt-[3vmin] max-w-[42vmin] text-[2vmin] leading-[1.35] text-[#5f756f]"
                  initial={{ opacity: 0, y: 15 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1.15, duration: 0.7, ease: EASE }}
               >
                  OCare helps patients find a real clinic slot before they leave
                  home.
               </motion.p>
               <motion.div
                  className="mt-[5vmin] h-[.8vmin] w-[18vmin] rounded-full bg-[#f29d63]"
         ...
         <FloatingStamp className="right-[9vmin] top-[18vmin] rotate-3">
            <span className="text-[#d95d45]">Morning rush</span>
            <br />
            <span className="font-normal text-[#5f756f]">Lekki • 8:07 am</span>
         </FloatingStamp>
         <motion.div
            className="absolute bottom-[15vmin] right-[14vmin] z-10 rounded-[2vmin] bg-[#123837] px-[2.2vmin] py-[1.6vmin] text-[1.4vmin] font-bold text-[#fffaf3] ui-shadow"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1.4, duration: 0.7, ease: EASE }}
         >
            <span className="mr-[1vmin] inline-block h-[.8vmin] w-[.8vmin] rounded-full bg-[#f29d63]" />{" "}
            Appointment-first care
         </motion.div>
         <SceneFooter page="01" />
      </SceneShell>
   );
